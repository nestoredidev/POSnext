        ...
        <div className="px-4 sm:px-6 lg:px-8 mt-10">
            <div className="mt-8 flow-root ">
                <div className="-mx-4 -my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
                    <div
                        className="inline-block min-w-full py-2 align-middle sm:px-6 lg:px-8 bg-white p-5 rounded-lg ">
                                ...
                                <tr key={product.id}>
                                    ...
                                    <td className="px-3 py-4 text-sm text-gray-500">
                                        {isAvailable(product.inventory) ? (
                                            ...
                                            <p className="bg-red-600 rounded-lg px-3 py-1 text-xs text-white text-center">Agotado</p>}
